class TreeGenerator {
    constructor(worldConfig, clientConfig, blockTypes, simplexNoise) {
    ...
    generateTree(chunk, x, y, z, biomeType) {
        ...
        this.generateLeaves(chunk, x, y + height, z, biomeConfig.LEAF_CONFIG);
    }
...
self.onmessage = function(e) {
    switch (e.data.type) {
        case 'init':
            if (typeof self.SimplexNoise === 'undefined') {
                importScripts('./noise/simplex-noise.js');
            }
            ...
            treeGenerator = new TreeGenerator(worldConfig, client_config, block_type, simplexNoise);
        ...
        case 'applyModifications':
            ...
            break;
        case 'generateChunk':
            const { chunkX: genChunkX, chunkY: genChunkY, chunkZ: genChunkZ } = e.data;
            ...
            break;
        case 'updateBlock':
            const { chunkX, chunkY, chunkZ, localX, localY, localZ, blockType } = e.data;
...
function generateOceanBlock(x, y, z, surfaceHeight) {
