import { createPlayer, createOtherPlayer, addPlayerControls, checkCollisions } from './root/players.js';
import { createMiniMap } from './root/minimap.js';
...
function setupSocketConnection() {
    ...
    socket.emit('getInitialState', player.position);
}
